...
public abstract class AbstractObjectTransformer<TX extends IAbstractObjectTransformer<TX, OIN, OUT>, OIN, OUT>
    extends Transformer.BaseTransformer<TX, OIN, OUT> implements IAbstractObjectTransformer<TX, OIN, OUT> {

  public <IN> AbstractObjectTransformer(String transformerName, Transformer<?, OIN, IN> parent, Function<? super IN, ? extends OUT> function, OIN originalInputValue) {
