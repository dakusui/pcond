...
public interface BooleanVerifier<OIN> extends Identifiable, Predicate<OIN>, Evaluable<OIN>, Evaluable.Transformation<OIN, Boolean>, IVerifier<BooleanVerifier<OIN>, OIN, Boolean>, Matcher.ForBoolean<OIN> {
  @Override
  ...
  class Impl<OIN> extends Verifier<BooleanVerifier<OIN>, OIN, Boolean> implements BooleanVerifier<OIN> {
