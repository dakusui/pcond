...
public interface MetamorphicTestCaseFactoryWithPreformer<X, I, O, P, R> extends MetamorphicTestCaseFactory<X, I, O, R> {
  ...
  class Builder<X, I, O, P, R> extends BuilderBase<Builder<X, I, O, P, R>, X, I, O, R> {
    ...
    public <QQ> Builder<X, I, O, QQ, R> chainPreformer(Function<P, QQ> preformer) {
    ...
    public <QQ> Builder<X, I, O, QQ, R> chainPreformer(String name, Function<P, QQ> preformer) {
      return this.chainPreformer(Printables.function(name, preformer));
    }
    ...
    public Builder<X, I, O, P, R> reducer(String reducerName, Function<Dataset<P>, R> reducer) {
      return this.reducer(Printables.function(reducerName, reducer));
    }
