...
public interface AssertionProviderBase extends AssertionProvider {
  ...
  interface ReportComposer {
    ...
    static String composeReport(String summary, List<Object> details, AtomicInteger index) {
    ...
    static String composeExplanationForActualResults(List<Evaluator.Entry> result, Throwable t, List<Object> actualInputDetails) {
    ...
    static String composeExplanationForExpectations(List<Evaluator.Entry> result, Throwable t, List<Object> expectationDetails) {
      return composeExplanation(result.stream()
          .map((Evaluator.Entry each) -> evaluatorEntryToFormattedEntry(
              each,
              () -> (each.hasOutput() ?
    ...
    static String composeExplanation(List<FormattedEntry> formattedEntries) {
    ...
    static FormattedEntry evaluatorEntryToFormattedEntry(Evaluator.Entry entry, Supplier<String> outputFormatter) {
    ...
    static Function<FormattedEntry, String> formattedEntryToString(
    ...
    static String evaluatorEntriesToString(List<FormattedEntry> formattedEntries, Function<int[], Function<FormattedEntry, String>> formatterFactory) {
  ...
  class Explanation {
    ...
    public static Explanation fromMessage(String msg) {
      return new Explanation(msg, ReportComposer.composeReport(null, null, new AtomicInteger(0)), ReportComposer.composeReport(null, null, new AtomicInteger(0)));
    }
  }
}
