...
public class FluentStyleExample {
  ...
  public void givenValidName_whenValidatePersonName_thenPass() {
    ...
    assertThat(
        s,
        $().asString().split(" ").thenVerifyWithAllOf(asList(
          $().asListOfClass(String.class).elementAt(0).then()
             .asString().isNullOrEmpty().negate(),
          $().asListOfClass(String.class).elementAt(1).then()
             .asString().isNullOrEmpty().negate())));
  }
}
----
