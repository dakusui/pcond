...
public class PrintableTest {
  public static class FunctionTest extends TestBase {
    Function<String, String> appendA = Crest.function("append[A]", s -> s + "A");
    Function<String, String> appendB = Crest.function("append[B]", s -> s + "B");
  ...
  public static class PredicateTest extends TestBase {
    Predicate<String> isA = Crest.predicate("is[A]", "A"::equals);
    Predicate<String> isB = Crest.predicate("is[B]", "B"::equals);
