...
public class MoreFluentStreamTest {
  ...
  public void test_noneMatche() {
    ...
    assertStatemet(value(var).then().noneMatch(isEqualTo("HELLO")));
  }

  @Test
  public void test_anyMatch() {
    Stream<String> var = Stream.of("hello", "world");
    assertStatemet(value(var).then().anyMatch(isEqualTo("world")));
  }

  @Test
  public void test_allMatch() {
    Stream<String> var = Stream.of("hello", "world");
    assertStatemet(value(var).then().allMatch(isNotNull()));
  }
}
